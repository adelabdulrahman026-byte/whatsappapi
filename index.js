...
app.listen(port, '0.0.0.0', () => {
    ...
    console.log('هنستنى 15 ثانية عشان السيرفر يستقر و Render ميعملش ريستارت...');
    
    // السر هنا: هنأخر تشغيل المتصفح التقيل عشان السيرفر ميقعش
    setTimeout(() => {
        console.log('جاري تشغيل الواتساب الآن...');
        client.initialize();
    }, 15000); 
});
